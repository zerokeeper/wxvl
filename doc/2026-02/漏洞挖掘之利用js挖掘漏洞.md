#  漏洞挖掘之利用js挖掘漏洞  
中铁13层打工人
                    中铁13层打工人  陌笙不太懂安全   2026-02-14 10:05  
...
```
作者:中铁13层打工人
原文连接:https://forum.butian.net/index.php/share/3915
```  
# 前言：  
...
![](https://mmbiz.qpic.cn/mmbiz_png/MSDUaqtwboQ9sm0rGvq6sey9xsF60xyMqMkVeF8K9YUCufJRtDW1Vukica6eXrfMkp7mAzKDIEBvhS2eM2QMuaKGXjpfqX8mupcegJzPtPlk/640?wx_fmt=png&from=appmsg "")  
  
下来就可以直接发包，替换加密参数进行测试了：  
  
![](https://mmbiz.qpic.cn/mmbiz_png/MSDUaqtwboS2x15UJpXibHgNUVUCVzrOjWNIbgh5vLoApJmlh4yEajiclHiaKjHwOMydx0Ayq9996ecb1G3vr8CYW89icIKnYl4bQzjs2affRsE/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_png/MSDUaqtwboTo8c5QgeLDblz8vtz355NcHYZp4ob9Bcxq8C83pOKRJwnCd7MKLaeYcJHJF1ddEyic9H95sh6cc6ZpvEFfia0dicwTj2NweLWZs0/640?wx_fmt=png&from=appmsg "")  
  
2、注入JS，构建通信环境。JS位置：（/resouces/JsEnv_De.js）  
  
把js中的内容直接复制粘贴进控制台运行。  
  
![](https://mmbiz.qpic.cn/mmbiz_png/MSDUaqtwboRE8PVqG6KUIRdEUc3l2xJslibpHP4Y8vet6cNT9kNFniaicNibQmvLqfel4F2icLMJnianW6odLEib2SnVZlxIAGp4r0zVgDtehWPQ2s/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/MSDUaqtwboRoUjznw16M0eaXP7kDVowYsxiaUvzibic6WC1UHhcZnl6ObiagRq6icCRMtXKepibMIhxXw4icQS5o3h1ibPqLs3twcaruIWRQm5uOiaxk/640?wx_fmt=png&from=appmsg "")  
  
完成后效果图如下：  
  
![](https://mmbiz.qpic.cn/mmbiz_png/MSDUaqtwboQ6ZV1641uWlO0TPwzMb9kjymicKTVGy5zib6dRHzZqU636r9PbRJXQPHBlkbU3lhDlBLELWxCbeZoumR5vX7hpIoKsUIsnTq8gw/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_png/MSDUaqtwboRBa2sT8BwpNMZCOBOs7daCybCPudlPI74WEiaicmQsXbs4lw1G0eqjgPJBosIXtbNG9AtshyOibvuCmlGibgT1TrX3W2sphYXHpOc/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/MSDUaqtwboQ8Vy5aTGIfS7H9c0QVqBNZoPLShanfIhWXnknV9ZbaAB7LNZQTibZCcccsqlBe5ribavwHVsStmvibiaWpkw5awZ6wsiaCFH9ze0icA/640?wx_fmt=png&from=appmsg "")  
  
已知e是rsa公钥，所以传入密钥看下通过自定义的函数传参后的加密结果：  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/MSDUaqtwboQ5fmA9HO6Aib2YjgHOgYLTw4ZF0vEE8NUEZJ5Y2DxGIicRpPw5F4v1Y6icfg3woK0AT5BmGW25CJt9GrXTC08uMr5H9nhnSCFn1w/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/MSDUaqtwboRtjs6sWVUJC0SpfIlRndGWKnVtibIbjXdtNLZmC9JpqYFL1Emopvicd6OGkNxbCo20dFlIsuR06SSCiaGycNibaoeMntsRpcA1Ihk/640?wx_fmt=png&from=appmsg "")  
  
综上，可以实现远程调用加密函数，省去了对原加密函数进行脚本转化的过程，使得测试更加便利。  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/MSDUaqtwboQnWSB04yuHOrIicj68x5iaTMDfrBv7yqUia9WRqsVHcACevEeAbLVHdJpoicicdfzIsLJibrV5CZKveOpSRQecQbLWWUG8WC6Wgm57M/640?wx_fmt=png&from=appmsg "")  
